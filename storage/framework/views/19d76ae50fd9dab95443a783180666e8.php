...
.tt-card-time {
    ...
    background: <?php echo e($p['light']); ?>; color: <?php echo e($p['text']); ?>; white-space: nowrap; flex-shrink: 0;
}
...
.tt-card-icon {
    ...
    background: <?php echo e($p['light']); ?>; flex-shrink: 0;
...
/* Variants */
.tt-action-btn.btn-edit:hover   { background: <?php echo e($p['light']); ?>;  color: <?php echo e($p['text']); ?>; }
...
.promo-select {
    ...
    background: white; font-size: 12px; font-weight: 600; color: <?php echo e($accentColor); ?>;
...
.promo-select:focus { border-color: <?php echo e($accentColor); ?>; }
...
.tt-day-pill.today-pill { border-color: <?php echo e($accentColor); ?>; color: <?php echo e($accentColor); ?>; }
.tt-day-pill.active     { background: <?php echo e($accentColor); ?>; border-color: <?php echo e($accentColor); ?>; color: white; }
...
.tt-mobile-foot-btn.cls:hover        { background: <?php echo e($p['light']); ?>; color: <?php echo e($p['text']); ?>; }
...
<div class="tt-header-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; margin-bottom:20px;">
    ...
    <div class="tt-header-left" style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
        <div style="display:inline-flex; border-radius:12px; overflow:hidden; border:1.5px solid #e2e8f0; background:white;">
            ...
            <?php if($tab2Disabled): ?>
                <span class="tt-tab disabled" style="border-left:1.5px solid #e2e8f0;" title="Vous êtes inscrit en <?php echo e($stagiaireYear); ?>ème année">Année 2 &nbsp;🔒</span>
            <?php else: ?>
    ...
    <div class="tt-header-right" style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
        ...
        <form id="publish-form" method="POST"
            ...
            <?php echo csrf_field(); ?>
            <button type="button"
                    onclick="<?php echo e($draftCount > 0 ? 'openPublishModal()' : ''); ?>"
...
<div class="tt-mobile-nav" id="tt-mobile-day-nav">
    <?php $__currentLoopData = $dayDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayNum => $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button
            class="tt-day-pill <?php echo e($date->isToday() ? 'today-pill' : ''); ?> <?php echo e($loop->first ? 'active' : ''); ?>"
            data-day="<?php echo e($dayNum); ?>"
            onclick="switchMobileDay(<?php echo e($dayNum); ?>)">
            <div><?php echo e($date->translatedFormat('D')); ?></div>
            <div style="font-size:14px; font-weight:800;"><?php echo e($date->format('d')); ?></div>
        </button>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
...
<div class="tt-mobile-grid" id="tt-mobile-grid">
    <?php $__currentLoopData = $dayDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayNum => $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="tt-mobile-day-block" data-day="<?php echo e($dayNum); ?>" style="<?php echo e($loop->first ? '' : 'display:none;'); ?>">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $groupesByFiliere; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filiereId => $groupes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="tt-mobile-filiere"><?php echo e($filiere->name ?? 'Filière'); ?></div>
                ...
                <?php $__currentLoopData = $groupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="tt-mobile-group">
                        <div class="tt-mobile-group-header">
                            <div style="width:3px; height:18px; border-radius:99px; background:<?php echo e($accentColor); ?>; flex-shrink:0;"></div>
                            <span><?php echo e($groupe->name ?? 'G'.$groupe->id); ?></span>
                            <span style="font-size:9px; color:#94a3b8; font-weight:500; margin-left:auto;"><?php echo e($groupe->option->titre ?? $filiere->name ?? ''); ?></span>
                        </div>

                        <?php $hasSessions = false; ?>
                        ...
                        <?php else: ?>
                            <?php $__currentLoopData = EmploiDuTempsController::SEANCES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sNum => $seance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($cell['type'] === 'session'): ?>
                                    ...
                                    <div class="tt-mobile-session" style="border-top-color:<?php echo e($topColor); ?>; <?php echo e($isDraft ? 'opacity:.75; border-style:dashed; border-top-style:dashed; background:#f8fafc;' : ($isRemote ? 'background:#fffbeb;' : '')); ?>">
                                        <div class="tt-mobile-session-body">
                                            ...
                                            <div class="tt-mobile-session-header">
                                                <div class="tt-mobile-session-module"
                                                     style="<?php echo e($isDraft ? 'color:#475569;' : ($isRemote ? 'color:#92400e;' : '')); ?>">
                                                    <?php echo e($emploi->module->name ?? 'Module'); ?>

                                                </div>
                                                <div class="tt-mobile-session-badge"
                                                     style="<?php echo e($isRemote ? 'background:#fef3c7; color:#b45309;' : ''); ?>">
                                                    <?php echo e($spanLbl); ?> · <?php echo e($totalH); ?>h
                                                </div>
                                            </div>
                                            ...
                                            <div class="tt-mobile-session-meta">
                                                <?php if($hasRemplacant): ?>
                                                    <div class="tt-mobile-session-row" style="flex-direction:column; align-items:flex-start; gap:3px;">
                                                        <div style="display:flex; align-items:center; gap:6px;">
                                                            ...
                                                            <span style="font-size:10px; color:#94a3b8; text-decoration:line-through;"><?php echo e($emploi->gestionnaire->name ?? '—'); ?></span>
                                                        </div>
                                                        <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                                                            <div style="width:5px; height:5px; border-radius:50%; background:#7c3aed; flex-shrink:0;"></div>
                                                            <span style="font-size:11px; color:#5b21b6; font-weight:700;"><?php echo e($activeRemplacant->name); ?></span>
                                                ...
                                                <?php else: ?>
                                                    <div class="tt-mobile-session-row">
                                                        <svg width="13" height="13" fill="none" stroke="<?php echo e($accentColor); ?>" viewBox="0 0 24 24">
                                                            <circle cx="12" cy="7" r="4" stroke-width="2"/>
                                                            <path stroke-width="2" d="M4 21v-1a8 8 0 0116 0v1"/>
                                                        </svg>
                                                        <?php echo e($emploi->gestionnaire->name ?? '—'); ?>
                    ...
                    <?php elseif($cell['type'] === 'session'): ?>
                        ...
                        <td class="tt-session-td" colspan="<?php echo e($colspan); ?>" style="<?php echo e($spanBorder); ?>">
                            <div class="tt-card <?php echo e($cardClass); ?>">
                                ...
                                <?php if($canEdit || $canDelete || $canLien || $isGestionnaire || $canReport): ?>
                                <div class="tt-actions">
                                    ...
                                    <button type="button"
                                            ...
                                            onclick="openEditModal(<?php echo e($emploi->id); ?>)"
                                    ...
                                    <?php if($canDelete && ($canEdit || $canReport || $canLien)): ?>
    ...
    <div style="background:white; border-radius:20px; width:100%; max-width:420px;
        ...
        <div style="display:flex; align-items:center; gap:12px; padding:12px 14px;
            ...
            <div>
                <div style="font-size:12px; font-weight:700; color:#166534;">
                    Semaine du <?php echo e($weekStart->translatedFormat('d M')); ?> au <?php echo e($weekEnd->translatedFormat('d M Y')); ?>

                </div>
                <div style="font-size:10px; color:#15803d; margin-top:2px;">
                    <span style="font-weight:800;"><?php echo e($draftCount); ?></span> séance<?php echo e($draftCount > 1 ? 's' : ''); ?> en brouillon à publier
                </div>
            </div>
        </div>
        ...
        <div style="display:flex; gap:10px;">
            ...
            <button type="button" onclick="submitPublish()"
                ...
                Oui, publier <?php echo e($draftCount); ?> séance<?php echo e($draftCount > 1 ? 's' : ''); ?>
...
function openModalWithSlot(dayNum, seanceNum, dateStr, groupeId) {
    ...
    if (formEl)     formEl.action          = '<?php echo e(route('emplois.store')); ?>';
