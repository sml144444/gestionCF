                                ...
                                <?php if($cell['type'] === 'session'): ?>
                                    ...
                                    <div class="tt-mobile-session" style="border-top-color:<?php echo e($topColor); ?>; <?php echo e($isDraft ? 'opacity:.75; border-style:dashed; border-top-style:dashed; background:#f8fafc;' : ($isRemote ? 'background:#fffbeb;' : '')); ?>">
                                        ...
                                        <div class="tt-mobile-session-footer">
                                            <a href="<?php echo e(route('seances.show', $emploi)); ?>" class="tt-mobile-foot-btn">
                                            ...
                                            <a href="<?php echo e(route('seances.show', $emploi)); ?>#classroom"
                                               class="tt-mobile-foot-btn" style="color:<?php echo e($p['text']); ?>;">
                                                <svg width="12" height="12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <td class="tt-session-td" colspan="<?php echo e($colspan); ?>" style="<?php echo e($spanBorder); ?>">
                            <div class="tt-card <?php echo e($cardClass); ?>">
                                ...
                                <div class="tt-card-footer">
                                    <a href="<?php echo e(route('seances.show', $emploi)); ?>" class="tt-foot-btn" title="Voir le détail">
                                    ...
                                    <?php if(in_array(Auth::user()->role, ['admin','gestionnaire','formateur'])): ?>
                                        <?php if(!$isDraft): ?>
                                            <a href="<?php echo e(route('seances.show', $emploi)); ?>#presence" class="tt-foot-btn tt-foot-btn-pres">
                                                <svg width="11" height="11" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                          d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                                                </svg>
                                    ...
                                    <a href="<?php echo e(route('seances.show', $emploi)); ?>#classroom" class="tt-foot-btn tt-foot-btn-cls">
                                        <svg width="11" height="11" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-width="2" stroke-linecap="round"
                                                  d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                                        </svg>
