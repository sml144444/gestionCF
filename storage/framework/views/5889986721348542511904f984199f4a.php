         ...
         <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
            ...
            <tr>
               <td style="background:white;padding:36px 48px;">
                  ...
                  <div style="background:#eef2ff;border-radius:16px;border:1.5px solid #c7d2fe;
                              padding:24px 28px;margin-bottom:28px;">
                     <div style="font-size:10px;font-weight:800;color:#4338ca;letter-spacing:2px;
                                 text-transform:uppercase;margin-bottom:16px;">
                        🔐 Vos identifiants de connexion
                     </div>
                     <ul style="margin:0;padding-left:20px;list-style-type:disc;color:#1e293b;font-size:14px;">
                        <li style="margin-bottom:10px;">
                           <strong>Email :</strong> <span style="font-family:'Courier New',monospace;"><?php echo e($user->email); ?></span>
                        </li>
                        <li style="margin-bottom:10px;">
                           <strong>Mot de passe :</strong> <span style="font-family:'Courier New',monospace;background:#e2e8f0;padding:2px 8px;border-radius:6px;"><?php echo e($plainPassword); ?></span>
                        </li>
                     </ul>
                     <p style="margin:14px 0 0 0;font-size:12px;color:#475569;">
                        📎 Connectez-vous sur : <a href="<?php echo e(url('/login')); ?>" style="color:#1a5fa8;font-weight:600;"><?php echo e(url('/login')); ?></a>
                     </p>
                  </div>
                  ...
                  <div style="background:#f8fafc;border-radius:16px;border:1.5px solid #e2e8f0;
                     ...
                     <div style="margin-bottom:12px;padding-bottom:12px;border-bottom:1px solid #f1f5f9;">
                        ...
                        <span style="font-size:15px;font-weight:700;color:#0f172a;"><?php echo e($user->name); ?></span>
                     </div>

                     <div style="margin-bottom:12px;padding-bottom:12px;border-bottom:1px solid #f1f5f9;">
                        <span style="font-size:11px;font-weight:700;color:#64748b;
                                     text-transform:uppercase;letter-spacing:1px;">Adresse e-mail personnel</span><br>
                        <span style="font-size:14px;font-weight:600;color:#0f172a;
                                     font-family:'Courier New',monospace;"><?php echo e($user->email); ?></span>
                     </div>
...
</html><?php /**PATH C:\Project\gestion-CF\resources\views/emails/welcome-stagiaire.blade.php ENDPATH**/ ?>