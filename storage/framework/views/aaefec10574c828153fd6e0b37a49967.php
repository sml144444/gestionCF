...
<?php $__empty_1 = true; $__currentLoopData = $reclamations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    ?>
    <div id="rec-row-<?php echo e($rec->id); ?>" class="ticket-card <?php echo e($newReply ? 'new-reply' : ''); ?>">
        <div class="ticket-head">
            ...
            <span id="status-badge-<?php echo e($rec->id); ?>" class="badge"
        ...
        <div class="ticket-footer">
            <div style="display:flex;align-items:center;gap:10px;">
                <span class="msg-count <?php echo e($hasNew ? 'has-msgs' : ''); ?>" id="msg-count-<?php echo e($rec->id); ?>">
