...
<div class="wrapper">
    <div class="card">
        ...
        <div class="trace-box">
            ...
            <div class="trace-code">ERR_500 · <?php echo e(now()->format('YmdHis')); ?> · <?php echo e(request()->ip()); ?></div>
        </div>
...
</html><?php /**PATH C:\Project\gestion-CF\resources\views/errors/500.blade.php ENDPATH**/ ?>