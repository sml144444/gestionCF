...
<div class="wrapper">
  ...
  <div class="body">
    <?php if(! empty($greeting)): ?>
      <p class="greeting"><?php echo e($greeting); ?></p>
    <?php else: ?>
      <p class="greeting">Bonjour,</p>
    <?php endif; ?>

    <?php $__currentLoopData = $introLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <p class="intro-line"><?php echo e($line); ?></p>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    <?php if(isset($actionText)): ?>
      <div class="btn-wrap">
        <a href="<?php echo e($actionUrl); ?>" class="btn"><?php echo e($actionText); ?></a>
      </div>
    <?php endif; ?>

    <?php $__currentLoopData = $outroLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <p class="extra"><?php echo e($line); ?></p>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

    <div class="divider"></div>
    <p class="extra">
      <?php echo e($salutation ?? 'Cordialement,'); ?><br>
  ...
  <div class="footer">
    ...
    <a href="<?php echo e(url('/login')); ?>">Se connecter</a> &nbsp;·&nbsp;
    <a href="mailto:admin@ofppt.ma">Contacter l'administration</a>
  </div>

</div>
</body>
</html><?php /**PATH C:\Project\gestion-CF\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>