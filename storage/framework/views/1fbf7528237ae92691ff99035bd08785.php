...
:root {
    ...
    --medium:     <?php echo e($p['medium']); ?>;
    --light:      <?php echo e($p['light']); ?>;
    --lighter:    <?php echo e($p['lighter']); ?>;
    --text-col:   <?php echo e($p['text']); ?>;
    --border-col: <?php echo e($p['border']); ?>;
    --shadow:     <?php echo e($p['shadow']); ?>;
    --gradient:   <?php echo e($p['gradient']); ?>;
    --ring:       <?php echo e($p['ring']); ?>;
}
    ...
    <div class="filter-bar">
        ...
        <form method="GET" action="<?php echo e(route('reclamations.index')); ?>"
            ...
            <?php if(!$reclamations->isEmpty()): ?>
                <span class="filter-count-badge"><?php echo e($reclamations->total()); ?> résultat(s)</span>
            <?php endif; ?>
        </form>
    </div>
                ...
                <table class="rc-table">
                    ...
                    <?php $__currentLoopData = $reclamations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr id="rec-row-<?php echo e($rec->id); ?>">
                            <td data-label="#">
                                <span class="row-id">#<?php echo e($rec->id); ?></span>
                            </td>
                            <td data-label="Stagiaire">
                                <div style="display:flex;align-items:center;gap:10px;">
                                    <div class="avatar-sm"><?php echo e($initials); ?></div>
                                    <div>
                                        <div style="font-weight:700;font-size:13px;color:#1e293b;"><?php echo e($sName); ?></div>
                                        <div style="font-size:10px;color:#94a3b8;margin-top:1px;"><?php echo e($rec->stagiaire?->email ?? ''); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td data-label="Type">
                                <span class="badge type-badge"><?php echo e($tc['icon']); ?> <?php echo e($tc['label']); ?></span>
                            </td>
                            ...
                            <td data-label="Messages">
                                <span class="msg-count <?php echo e($rec->messages_count > 0 ? 'has-new' : ''); ?>">
                            ...
                            <td data-label="Assigné à">
                                <?php if($rec->assignee): ?>
                                    ...
                                    <div style="font-size:12px;font-weight:700;color:#1e293b;"><?php echo e($rec->assignee->name); ?></div>
                                    <span class="role-badge" style="background:<?php echo e($ar['bg']); ?>;color:<?php echo e($ar['color']); ?>;margin-top:3px;display:inline-block;">
                                        <?php echo e($ar['label']); ?>
                            ...
                            <td data-label="Date">
                                <div class="date-main"><?php echo e($rec->created_at->format('d/m/Y')); ?></div>
                                <div class="date-time"><?php echo e($rec->created_at->format('H:i')); ?></div>
                            </td>
                            <td data-label="Actions">
                                <div style="display:flex;align-items:center;flex-wrap:wrap;gap:4px;">
                                    ...
                                    <button onclick="confirmDelete(<?php echo e($rec->id); ?>)" class="btn-del">
                                        🗑️ Sup.
                                    </button>
