...
<div class="wrapper">
    <div class="card">
        ...
        <div class="actions">
            ...
            <a href="<?php echo e(url()->previous() !== url()->current() ? url()->previous() : '/'); ?>" class="btn-ghost">
...
</html><?php /**PATH C:\Project\gestion-CF\resources\views/errors/404.blade.php ENDPATH**/ ?>