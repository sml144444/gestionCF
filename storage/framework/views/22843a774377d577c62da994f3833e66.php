...
<style>
:root {
    --primary:      <?php echo e($c['primary']); ?>;
    --primary-dark: <?php echo e($c['primary_dark']); ?>;
    --primary-mid:  <?php echo e($c['primary_mid']); ?>;
    --gradient:     <?php echo e($c['gradient']); ?>;
    --light:        <?php echo e($c['light']); ?>;
    --lighter:      <?php echo e($c['lighter']); ?>;
    --border-col:   <?php echo e($c['border']); ?>;
    --text-col:     <?php echo e($c['text']); ?>;
    --badge-bg:     <?php echo e($c['badge_bg']); ?>;
    --badge-text:   <?php echo e($c['badge_text']); ?>;
    --avatar-bg:    <?php echo e($c['avatar_bg']); ?>;
    --avatar-text:  <?php echo e($c['avatar_text']); ?>;
    --ring:         <?php echo e($c['ring']); ?>;
    --mine-bg:      <?php echo e($c['msg_mine_bg']); ?>;
    --their-bg:     <?php echo e($c['msg_their_bg']); ?>;
    --their-border: <?php echo e($c['msg_their_border']); ?>;
    --their-text:   <?php echo e($c['msg_their_text']); ?>;
}
...
<div class="rc-page">
    ...
    <div class="rc-header">
        <div class="rc-header-left">
            <a href="<?php echo e(route('reclamations.index')); ?>" class="rc-back-btn">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 19l-7-7 7-7"/>
                </svg>
            </a>
            <div>
                <div class="rc-header-sub"><?php echo e($tc['icon']); ?> <?php echo e($tc['label']); ?> &nbsp;·&nbsp; #<?php echo e($reclamation->id); ?></div>
    ...
    <div class="rc-body">
        ...
        <div class="rc-chat">
            ...
            <div class="rc-chat-head">
                <?php if($isStagiaire): ?>
                    <div>
                        ...
                        <div class="rc-peer-email">Ouverte le <?php echo e($reclamation->created_at->format('d/m/Y à H:i')); ?></div>
                    </div>
                <?php else: ?>
                    <div style="display:flex;align-items:center;gap:10px;">
                        ...
                        <div>
                            <div class="rc-peer-name"><?php echo e($reclamation->stagiaire?->name); ?></div>
                            <div class="rc-peer-email"><?php echo e($reclamation->stagiaire?->email); ?></div>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="rc-msg-count"><?php echo e($reclamation->messages->count()); ?> msgs</div>
            </div>
            ...
            <div class="rc-messages" id="messages-area">
                ...
                <div class="msg-bubble <?php echo e($isStagiaire ? 'mine' : 'theirs'); ?>">
                    ...
                    <div class="msg-footer">
                        <div class="msg-time"><?php echo e($reclamation->created_at->format('H:i')); ?></div>
                    </div>
                </div>
                ...
                <div class="msg-bubble <?php echo e($isMe ? 'mine' : 'theirs'); ?>"
                    ...
                    <?php if($canAct): ?>
                    <button class="msg-dots-btn" onclick="toggleMenu(event,<?php echo e($msg->id); ?>)" title="Options">⋯</button>
                    <div class="msg-actions" id="msg-menu-<?php echo e($msg->id); ?>">
                        <?php if($canEdit): ?>
                        <button class="msg-action-btn btn-edit-msg"
                                onclick="startEdit(<?php echo e($msg->id); ?>);closeAllMenus()">✏️ Modifier</button>
                        <?php endif; ?>
                        <button class="msg-action-btn btn-delete-msg"
                                onclick="deleteMsg(<?php echo e($msg->id); ?>);closeAllMenus()">🗑 Supprimer</button>
                    </div>
                    <?php endif; ?>
                    ...
                    <?php if (! ($isMe)): ?>
                        <div class="msg-sender">
                            ...
                            <span class="msg-sender-role">· <?php echo e(ucfirst($msg->sender?->role)); ?></span>
                        </div>
                    <?php endif; ?>

                    <?php if($msg->message): ?>
                    <div class="msg-content" id="msg-content-<?php echo e($msg->id); ?>">
                        <?php echo e($msg->message); ?>

                    </div>
                    <?php else: ?>
                    <div id="msg-content-<?php echo e($msg->id); ?>" style="display:none;"></div>
                    <?php endif; ?>
                        ...
                        <div class="attachment-container">
                            <?php if($msg->is_image): ?>
                                <a href="<?php echo e(asset('storage/'.$msg->attachment_path)); ?>" target="_blank">
                                    <img src="<?php echo e(asset('storage/'.$msg->attachment_path)); ?>"
                                         alt="<?php echo e($msg->attachment_name); ?>"
                                         class="attachment-image">
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(asset('storage/'.$msg->attachment_path)); ?>"
                                   target="_blank" download="<?php echo e($msg->attachment_name); ?>"
                    ...
                    <div class="msg-footer">
                        ...
                        <?php if($msg->edited_at): ?>
                            <div class="msg-edited">· modifié <?php echo e($msg->edited_at->format('H:i')); ?></div>
                        <?php endif; ?>
                        <?php if($isMe): ?>
                            <div class="msg-tick <?php echo e($msg->seen_at ? 'seen' : ''); ?>" title="<?php echo e($msg->seen_at ? 'Vu' : 'Envoyé'); ?>">
                                <?php echo e($msg->seen_at ? '✓✓' : '✓'); ?>
            ...
            <div id="traite-notice" class="traite-notice"
                 style="<?php echo e($reclamation->status !== 'traite' ? 'display:none;' : ''); ?>">
            ...
            <div id="reply-wrapper" class="rc-reply"
                 style="<?php echo e($reclamation->status === 'traite' ? 'display:none;' : ''); ?>">
                <form id="msg-form"
                      action="<?php echo e(route('reclamations.message', $reclamation)); ?>"
                      method="POST"
            ...
            <div class="sidebar-card">
                ...
                <div class="info-pill">
                    ...
                    <div>
                        ...
                        <div class="info-pill-val"><?php echo e($tc['icon']); ?> <?php echo e($tc['label']); ?></div>
                    </div>
                </div>
                ...
                <div class="info-pill">
                    ...
                    <div>
                        ...
                        <div class="info-pill-val"><?php echo e($reclamation->created_at->format('d/m/Y à H:i')); ?></div>
                    </div>
                </div>
                ...
                <div class="info-pill">
                    ...
                    <div>
                        ...
                        <div class="info-pill-val"><?php echo e($reclamation->stagiaire?->name ?? '—'); ?></div>
                    </div>
                </div>
                <?php endif; ?>

                <?php if($reclamation->assignedUser): ?>
                <div class="info-pill">
                    <div class="info-pill-icon">🎯</div>
                    <div>
                        <div class="info-pill-label">Assignée à</div>
                        <div class="info-pill-val"><?php echo e($reclamation->assignedUser->name); ?></div>
                    </div>
                </div>
                <?php else: ?>
                <div class="info-pill">
                ...
                <div class="info-pill">
                    ...
                    <div>
                        ...
                        <div class="info-pill-val"><?php echo e($reclamation->messages->count()); ?></div>
                    </div>
                </div>
            </div>
        ...
        window.Echo.private('reclamation.' + RECLAMATION_ID)
            ...
            .listen('.ReclamationDeleted', () => {
                ...
                const iv = setInterval(() => {
                    ...
                    if (n <= 0) { clearInterval(iv); window.location.href = '<?php echo e(route("reclamations.index")); ?>'; }
                }, 1000);
            })
