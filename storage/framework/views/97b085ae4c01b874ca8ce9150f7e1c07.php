...
<form method="GET" action="<?php echo e(route('modules.index')); ?>" class="mod-filter-bar">
    ...
    <a href="<?php echo e(route('modules.index', $anneeFilter ? ['annee'=>$anneeFilter] : [])); ?>"
                ...
                <div style="padding-top:8px;border-top:1px solid #f1f5f9;margin-bottom:10px;">
                    ...
                    <?php if($hasReplacement && $module->remplacant): ?>
                        <div class="repl-panel">
                            <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;margin-bottom:6px;">
                                ...
                                <?php if($canEdit): ?>
                                <form method="POST"
                                      action="<?php echo e(route('modules.replacement.deactivate', $module)); ?>"
                    ...
                    <?php elseif($canEdit): ?>
                        <details class="repl-assign-details">
                            ...
                            <form method="POST"
                                  action="<?php echo e(route('modules.replacement.activate', $module)); ?>"
                    ...
                    <?php if($pastReplacements->isNotEmpty()): ?>
                        <details class="repl-details" style="margin-top:8px;">
                            <summary>
                                <span class="repl-chevron">▶</span>
                                Historique (<?php echo e($pastReplacements->count()); ?> remplacement<?php echo e($pastReplacements->count() > 1 ? 's' : ''); ?> passé<?php echo e($pastReplacements->count() > 1 ? 's' : ''); ?>)
                            </summary>
