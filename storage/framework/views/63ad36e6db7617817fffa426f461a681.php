    ...
    <div id="step-1">
        <div class="edu-card">
            <div class="edu-card-head">
                ...
                <a href="<?php echo e(route('edu-import.template')); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:7px 14px;background:var(--accent-lt);border:1.5px solid var(--accent-bd);border-radius:10px;font-size:11px;font-weight:700;color:var(--accent-tx);text-decoration:none;">
            ...
            <div class="edu-card-body">
                <div style="border-radius:12px;overflow:hidden;margin-bottom:12px;border:1px solid var(--accent-bd);">
                    <div class="fmt-header">
                        <?php $__currentLoopData = ['edu_email','nom','prenom','filiere_code','groupe_code','password','promo (optionnel)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="fmt-cell"><?php echo e($h); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="fmt-row-a">
                        <?php $__currentLoopData = ['m.alami@ofppt.ma','Alami','Mohammed','DEVDIG','TDEV-101','MonPass123!','2025']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="fmt-cell"><?php echo e($v); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="fmt-row-b">
                        <?php $__currentLoopData = ['s.idrissi@ofppt.ma','Idrissi','Sara','GI','TGI-101','Sara2024!','']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="fmt-cell" style="<?php echo e($v==='' ? 'color:#94a3b8;font-style:italic;' : ''); ?>">
                                <?php echo e($v !== '' ? $v : 'auto-généré'); ?>
                            ...
                            <?php $__currentLoopData = $groupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="code-chip">
                                    ...
                                    <span class="code-chip-val">
                                        ...
                                        <?php if($g->promo): ?> — promo <?php echo e($g->promo); ?> <?php endif; ?>
                                    </span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
            ...
            <div class="filter-grid">
                <div style="grid-column:span 2;">
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="text" name="search" value="<?php echo e($filterSearch); ?>" placeholder="Nom, prénom ou email…" class="edu-input" style="padding-left:34px;">
                    </div>
                </div>
                <div>
                ...
                <div style="display:flex;gap:8px;align-items:flex-end;">
                    ...
                    <?php if($hasFilters): ?>
                    <a href="<?php echo e(route('edu-import.index', ['tab'=>'accounts'])); ?>" class="btn-ghost" style="flex:1;text-align:center;">✕ Reset</a>
                    <?php endif; ?>
                </div>
            </div>
        </form>
    ...
    <div class="edu-card">
        <div class="edu-card-head">
            <div>
                ...
                <p class="edu-card-sub">
                    <?php if($hasFilters): ?>
                        <strong style="color:var(--accent);"><?php echo e($eduAccounts->total()); ?></strong> résultat(s) filtrés sur <?php echo e($eduStats['total']); ?> total
                    <?php else: ?>
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                <span style="padding:4px 12px;border-radius:99px;font-size:10px;font-weight:700;background:#f0fdf4;color:#15803d;border:1px solid #bbf7d0;">✓ <?php echo e($eduStats['used']); ?> utilisés</span>
                <span style="padding:4px 12px;border-radius:99px;font-size:10px;font-weight:700;background:#fffbeb;color:#92400e;border:1px solid #fde68a;">⏳ <?php echo e($eduStats['pending']); ?> en attente</span>
            </div>
        </div>
        ...
        <?php if($eduAccounts->isEmpty()): ?>
            <div class="edu-card-body" style="padding:48px;text-align:center;">
                ...
                <p style="font-size:14px;font-weight:700;color:#1e293b;margin:0 0 4px;"><?php echo e($hasFilters ? 'Aucun résultat pour ces filtres' : 'Aucun compte EDU'); ?></p>
                <p style="font-size:12px;color:#94a3b8;margin:0;"><?php echo e($hasFilters ? 'Essayez de modifier ou réinitialiser les filtres.' : 'Importez des stagiaires pour les voir ici.'); ?></p>
            </div>
        <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex;align-items:center;gap:8px;">
                                    <div style="width:30px;height:30px;border-radius:8px;flex-shrink:0;background:var(--accent-lt);border:1px solid var(--accent-bd);display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:800;color:var(--accent-tx);"><?php echo e($initials); ?></div>
                                    <div style="font-weight:700;color:#0f172a;font-size:12px;"><?php echo e($edu->prenom ?? ''); ?> <?php echo e($edu->nom ?? ''); ?></div>
                                </div>
                            </td>
                            <td style="color:#1e40af;font-weight:600;"><?php echo e($edu->edu_email); ?></td>
                            <td>
                                <?php if($edu->filiere_code): ?>
                                    <span style="padding:2px 9px;border-radius:6px;font-size:10px;font-weight:700;background:var(--accent-lt);color:var(--accent-tx);"><?php echo e($edu->filiere_code); ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if($edu->groupe_code): ?>
                                    <span style="padding:2px 9px;border-radius:6px;font-size:10px;font-weight:700;background:#f1f5f9;color:#334155;"><?php echo e($edu->groupe_code); ?></span>
                                <?php else: ?>
                                    <span style="color:#94a3b8;">—</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <div style="font-size:11px;font-weight:600;color:#334155;"><?php echo e($edu->created_at->format('d M Y')); ?></div>
                                <div style="font-size:9px;color:#94a3b8;"><?php echo e($edu->created_at->format('H:i')); ?></div>
                            </td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edu-import')): ?>
                            <td>
                                <div style="display:flex;gap:6px;align-items:center;">
                                    ...
                                    <form method="POST" action="<?php echo e(route('edu-import.destroy', $edu->id)); ?>" onsubmit="return confirm('Supprimer <?php echo e($edu->prenom); ?> <?php echo e($edu->nom); ?> ? Cette action est irréversible.')">
                                        <?php echo csrf_field(); ?>
            ...
            <?php if($eduAccounts->hasPages()): ?>
                <div style="padding:14px 22px;border-top:1px solid #f1f5f9;"><?php echo e($eduAccounts->links()); ?></div>
            <?php endif; ?>
        <?php endif; ?>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr style="cursor:pointer;" onclick="openLogModal(<?php echo e($log->id); ?>)">
                            ...
                            <td onclick="event.stopPropagation()">
                                <button onclick="openLogModal(<?php echo e($log->id); ?>)" style="display:inline-flex;align-items:center;gap:5px;padding:5px 12px;border-radius:8px;border:1.5px solid var(--accent-bd);background:var(--accent-lt);color:var(--accent-tx);font-size:10px;font-weight:700;cursor:pointer;">
                                    <svg width="11" height="11" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="tab-manual" style="display:none;">
    <div class="edu-card">
        ...
        <div class="edu-card-body">
            <form method="POST" action="<?php echo e(route('edu-import.manual')); ?>" style="display:flex;flex-direction:column;gap:16px;">
                <?php echo csrf_field(); ?>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div><label class="edu-label">Nom</label><input type="text" name="nom" value="<?php echo e(old('nom')); ?>" placeholder="Alami" required class="edu-input"></div>
                    <div><label class="edu-label">Prénom</label><input type="text" name="prenom" value="<?php echo e(old('prenom')); ?>" placeholder="Mohammed" required class="edu-input"></div>
                </div>
                <div><label class="edu-label">Email EDU</label><input type="email" name="edu_email" value="<?php echo e(old('edu_email')); ?>" placeholder="m.alami@ofppt.ma" required class="edu-input"></div>
                <div>
                    <label class="edu-label">Mot de passe</label>
                    <input type="password" name="password" value="<?php echo e(old('password')); ?>" placeholder="Min. 6 caractères" required class="edu-input">
                    <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p style="font-size:11px;color:#dc2626;margin-top:4px;"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="promo" id="manual-promo" class="edu-input edu-select">
                        ...
                        <?php $__currentLoopData = $anneesScolaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $year = (int) explode('/', $annee)[0]; ?>
                            <option value="<?php echo e($year); ?>" <?php echo e(old('promo') == $year ? 'selected' : ''); ?>><?php echo e($annee); ?> (promo <?php echo e($year); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div>
                        ...
                        <select name="filiere_code" id="manual-filiere" required onchange="filterGroups(this.value)" class="edu-input edu-select">
                            ...
                            <?php $__currentLoopData = $filieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($f->code); ?>" <?php echo e(old('filiere_code') === $f->code ? 'selected' : ''); ?>><?php echo e($f->code); ?> — <?php echo e($f->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
                        ...
                        <div style="display:flex;gap:6px;height:40px;align-items:center;">
                            ...
                            <label style="flex:1;display:flex;align-items:center;justify-content:center;gap:5px;padding:6px;border-radius:9px;cursor:pointer;border:1.5px solid #e2e8f0;background:#f8fafc;font-size:11px;font-weight:700;color:#64748b;transition:all .15s;" id="annee-lbl-<?php echo e($val); ?>" onclick="selectAnnee(<?php echo e($val); ?>)">
                                <input type="radio" name="_annee_filter" value="<?php echo e($val); ?>" id="annee-radio-<?php echo e($val); ?>" style="display:none;" <?php echo e(old('_annee_filter', 1) == $val ? 'checked' : ''); ?>>
                                <?php echo e($label); ?>
