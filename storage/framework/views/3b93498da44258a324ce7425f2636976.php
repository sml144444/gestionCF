...
<head>
    ...
    <title>OFPPT – Nouveau mot de passe</title>
...
<body class="h-screen w-screen overflow-hidden flex">
    ...
    <div class="hidden lg:flex w-[45%] h-full flex-col items-center justify-around py-20 px-12
        ...
        <div class="relative z-10 flex flex-col items-center">
            <div class="w-28 h-28 rounded-full overflow-hidden bg-white shadow-xl flex items-center justify-center mb-6">
                <img src="<?php echo e(asset('images/ofppt-logo.webp')); ?>"
                    alt="OFPPT"
        ...
        <div class="relative z-10 bg-white/10 border border-white/20 rounded-2xl px-5 py-4 w-full text-center">
            <p class="text-white/80 text-xs leading-relaxed">
                Ce lien est valable <strong class="text-white">60 minutes</strong>.<br>
                Après expiration, vous devrez en demander un nouveau.
            </p>
        </div>
    </div>
    ...
    <div class="flex-1 h-full flex flex-col justify-center items-center bg-white px-6 overflow-y-auto">
        ...
        <div class="w-full max-w-md">
            ...
            <h2 class="text-2xl font-semibold text-center text-slate-800 mb-2">Nouveau mot de passe</h2>
            ...
            <form method="POST" action="<?php echo e(route('password.store')); ?>" class="space-y-5">
                ...
                <input type="hidden" name="email" value="<?php echo e(old('email', request()->query('email'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 flex items-start gap-3">
                    ...
                    <p class="text-xs text-blue-600 leading-relaxed">
                        Minimum <strong>6 caractères</strong>. Les deux champs doivent être identiques.
                    </p>
                </div>
...
</html><?php /**PATH C:\Project\gestion-CF\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>