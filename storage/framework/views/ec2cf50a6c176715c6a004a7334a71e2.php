...
<div style="padding:64px;text-align:center;background:white;border-radius:16px;border:1px solid #e2e8f0;">
    ...
    <p style="font-size:14px;font-weight:700;color:#334155;margin:0 0 4px;">Aucune demande <?php echo e($status === 'en_attente' ? 'en attente' : ($status === 'valide' ? 'acceptée' : ($status === 'refuse' ? 'refusée' : ''))); ?></p>
