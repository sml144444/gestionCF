                ...
                <tr>
                    <td style="background:linear-gradient(135deg,#1a4f8a 0%,#2563eb 100%); padding:36px 32px 28px; text-align:center;">
                        ...
                        <p style="margin:0; color:rgba(255,255,255,0.80); font-size:14px;">
                            Semaine du <strong><?php echo e($weekStart->translatedFormat('d M Y')); ?></strong>
                            au <strong><?php echo e($weekStart->copy()->addDays(5)->translatedFormat('d M Y')); ?></strong>
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <p style="margin:0 0 20px; font-size:15px; color:#1e293b; font-weight:600;">
                            Bonjour <?php echo e($stagiaire->name ?? 'Stagiaire'); ?> 👋
                        </p>

                        <p style="margin:0 0 20px; font-size:14px; color:#475569; line-height:1.7;">
                            Votre emploi du temps pour la semaine prochaine
                            (<strong style="color:#1e293b;">
                                <?php echo e($weekStart->translatedFormat('d M')); ?> –
                                <?php echo e($weekStart->copy()->addDays(5)->translatedFormat('d M Y')); ?>
                            ...
                            <tr>
                                <td align="center">
                                    <div style="display:inline-block; padding:10px 24px; border-radius:99px;
                                        ...
                                        <?php echo e($sessionCount); ?> séance<?php echo e($sessionCount > 1 ? 's' : ''); ?> planifiée<?php echo e($sessionCount > 1 ? 's' : ''); ?>

                                        &nbsp;·&nbsp; Groupe : <?php echo e($stagiaire->groupe->name ?? '—'); ?>
                        ...
                        <table role="presentation" width="100%" style="margin-bottom:24px; border-radius:12px; overflow:hidden; border:1px solid #e2e8f0;">
                            ...
                            <tr>
                                <td style="padding:10px 16px; border-bottom:<?php echo e($loop->last ? 'none' : '1px solid #f1f5f9'); ?>; font-size:13px; color:#334155;">
                        ...
                        <table role="presentation" width="100%" style="margin-bottom:28px;">
                            <tr>
                                <td align="center">
                                    <a href="<?php echo e(url(route('emplois.index', ['week' => $weekStart->toDateString(), 'year' => $stagiaire->groupe->annee ?? 1]))); ?>"
                ...
                <tr>
                    <td style="padding:20px 32px; background:#f8fafc; border-top:1px solid #e2e8f0; text-align:center;">
                        ...
                        <p style="margin:0; font-size:11px; color:#cbd5e1;">
                            © <?php echo e(date('Y')); ?> — Système de gestion de formation
                        </p>
                    </td>
                </tr>
...
</html><?php /**PATH C:\Project\gestion-CF\resources\views/emails/weekly_schedule.blade.php ENDPATH**/ ?>