        ...
        <div class="p-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <a href="<?php echo e($route); ?>"
               ...
               style="background:<?php echo e($bg); ?>;">
                ...
                <span class="text-xs font-bold leading-tight" style="color:<?php echo e($color); ?>;"><?php echo e($label); ?></span>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div class="px-5 py-4 space-y-3">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-[11px] text-slate-400 uppercase tracking-widest font-medium"><?php echo e($k); ?></span>
                    <span class="text-xs font-bold
                        <?php echo e($k === 'Environnement' && app()->isProduction() ? 'text-emerald-600' : ''); ?>

                        <?php echo e($k === 'Environnement' && !app()->isProduction() ? 'text-amber-600' : ''); ?>

                        <?php echo e(!in_array($k, ['Environnement']) ? 'text-slate-700' : ''); ?>">
                        <?php echo e($v); ?>
        ...
        <div class="rounded-2xl p-5 text-white" style="background: linear-gradient(135deg, #065f46, #059669);">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[10px] text-emerald-200 truncate"><?php echo e(Auth::user()->email); ?></p>
                </div>
            </div>
