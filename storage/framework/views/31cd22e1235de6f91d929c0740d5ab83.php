...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:4px;">
    ...
    <div style="border-radius:16px;padding:20px 24px;background:<?php echo e($fgBg); ?>;
                border:2px solid <?php echo e($fgBdr); ?>;
                display:flex;align-items:center;justify-content:space-between;
                gap:12px;flex-wrap:wrap;">
        <div>
...
<div style="border-radius:14px;padding:14px 20px;background:#f8fafc;
    ...
    <span style="font-size:15px;font-weight:800;color:<?php echo e($bannerClr); ?>;">
