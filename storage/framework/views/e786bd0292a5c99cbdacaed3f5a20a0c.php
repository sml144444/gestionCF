...
<?php $__env->startSection('page-title', 'Nouveau rôle'); ?>
    ...
    <div class="rc-card">
        <form action="<?php echo e(route('roles.store')); ?>" method="POST">
            ...
            <div class="rc-perm-group">
                <div class="rc-perm-group-header" onclick="toggleGroup('<?php echo e($groupKey); ?>')">
                    <div class="rc-perm-group-label">
                        ...
                        <span style="font-size:10px;color:#94a3b8;font-weight:500;">
                            <?php echo e(count($group['perms'])); ?> permission(s)
                        </span>
                    </div>
                ...
                <div id="group-<?php echo e($groupKey); ?>" class="rc-perm-group-body" style="display:none;">
                    <?php $__currentLoopData = $group['perms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permName => $permLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $cbId = 'cb-' . str_replace(['-','.',' '], '_', $permName); ?>
                        <div class="rc-perm-item" onclick="toggleCheck('<?php echo e($cbId); ?>')">
                            <input type="checkbox"
                                id="<?php echo e($cbId); ?>"
                                name="permission[]"
                                value="<?php echo e($permName); ?>"
                                data-group="<?php echo e($groupKey); ?>"
                                <?php echo e(in_array($permName, old('permission', [])) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Project\gestion-CF\resources\views/roles/create.blade.php ENDPATH**/ ?>