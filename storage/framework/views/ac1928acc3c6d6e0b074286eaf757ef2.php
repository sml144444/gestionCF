...
<body class="h-screen w-screen overflow-hidden bg-slate-100"
      style="--role-color: <?php echo e($roleColor); ?>;">
...
<aside id="sidebar" class="fixed top-0 left-0 h-full z-50 flex flex-col w-60 <?php echo e($sidebarColor); ?>">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('search-stagiaires')): ?>
    ...
    <header id="navbar">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-shrink:0;min-width:0;">
            ...
            <div style="display:flex;align-items:center;gap:6px;min-width:0;">
                ...
                <span class="nav-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
            </div>
        </div>
        ...
        <div style="display:flex;align-items:center;gap:2px;flex-shrink:0;">
            ...
            <?php echo $__env->make('partials.notifications.bell', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            <div class="vdivider" style="margin:0 6px;"></div>

            
            <a href="<?php echo e(route('profile.show')); ?>" class="user-pill">
                ...
                <div class="user-avatar" style="background:<?php echo e($avatarGradient); ?>;">
                    <?php echo e($initials); ?>
...
window.Echo.private('user.<?php echo e(Auth::id()); ?>')
    ...
    .listen('.ReclamationDeleted',e=>{
        ...
        if(location.href.includes('/reclamations/'+e.reclamation_id)) setTimeout(()=>location.href='<?php echo e(route("reclamations.index")); ?>',2000);
    })
