...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['modules_count'] ?? '—'); ?></p>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['groupes_count'] ?? '—'); ?></p>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-3">
            ...
            <?php if(($stats['reportations_pending'] ?? 0) > 0): ?>
                <span class="text-[10px] font-semibold text-orange-600 bg-orange-100 px-2 py-0.5 rounded-full">En attente</span>
            <?php endif; ?>
        </div>
        <p class="text-2xl font-bold text-slate-800"><?php echo e($stats['reportations_pending'] ?? '—'); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <a href="<?php echo e(route('seances.show', $seance)); ?>"
                   class="flex items-center gap-4 px-5 py-3.5 hover:bg-slate-50 transition-colors">
                    ...
                    <div class="w-10 text-center flex-shrink-0">
                        ...
                        <p class="text-lg font-bold text-blue-700 leading-none"><?php echo e($seance->date_debut->format('d')); ?></p>
                    </div>
                    
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-semibold text-slate-800 truncate">
                            <?php echo e($seance->module->name ?? 'Module non défini'); ?>
                    ...
                    <div class="text-right flex-shrink-0">
                        <p class="text-xs font-semibold text-slate-600"><?php echo e($seance->date_debut->format('H:i')); ?></p>
                    ...
                    <span class="text-[10px] font-semibold px-2 py-0.5 rounded-full flex-shrink-0
                        <?php echo e($seance->statut === 'actif' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'); ?>">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="mx-4 mb-4 mt-1 rounded-xl bg-blue-50 border border-blue-100 p-4">
            ...
            <p class="text-xs font-semibold text-blue-800"><?php echo e(Auth::user()->name); ?></p>
            <p class="text-[11px] text-blue-500"><?php echo e(Auth::user()->email); ?></p>
            <?php if(Auth::user()->specialite): ?>
            <p class="text-[11px] text-blue-500 mt-0.5"><?php echo e(Auth::user()->specialite); ?></p>
            <?php endif; ?>
        </div>
    </div>
