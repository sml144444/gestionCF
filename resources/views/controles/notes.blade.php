                ...
                <table class="notes-table" id="notesTable">
                    ...
                    @foreach($stagiaires as $i => $stagiaire)
                        <tr data-stagiaire="{{ $stagiaire->id }}">
                            ...
                            @foreach($controles as $ctrl)
                            {{--
                                FIX: use ?? null (not ?? '') so a saved note of 0 is
                                distinguishable from "no note". Then check !== null.
                                Also cast keys to int to avoid any string/int mismatch.
                            --}}
                            ...
                            {{-- Moyenne --}}
                            <td class="moy-cell">
                                <span id="moy-{{ $stagiaire->id }}" style="color:#94a3b8;">—</span>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
