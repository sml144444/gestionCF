{{--
    ...
    - Each item shows a count badge when count > 1
    - patchNotification(e) function added — updates existing item in-place
    - Delete button added to each notification
--}}
            ...
            @forelse($latest as $n)
                ...
                <div id="notif-item-{{ $n->id }}"
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="notif-message text-xs text-slate-700 leading-snug {{ $n->is_read ? '' : 'font-semibold' }}">
                            {{ $n->message }}
                        </p>
                    ...
                    {{-- Right side: delete button + count badge OR unread dot --}}
