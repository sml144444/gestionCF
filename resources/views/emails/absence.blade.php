                ...
                <tr>
                    <td style="background:#ffffff; padding:32px 36px;">
                        ...
                        <p style="margin:0 0 20px; color:#1e293b; font-size:15px; line-height:1.6;">
                            Bonjour <strong>{{ $stagiaire->name }}</strong>,
                        </p>
                                ...
                                <td style="padding:20px 22px;">
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding:3px 0;">
                                                <span style="font-size:11px; color:#64748b;">📍&nbsp;</span>
                                                <span style="font-size:12px; color:#475569;">{{ $emploi->salle->name }}</span>
                                            </td>
                                        </tr>
                                        @endif
                                        @if($enregistreePar)
                                        <tr>
                                            <td style="padding:3px 0;">
                                                <span style="font-size:11px; color:#64748b;">👤&nbsp;</span>
                                                <span style="font-size:12px; color:#475569;">Enregistrée par <strong>{{ $enregistreePar->name }}</strong></span>
                                            </td>
                                        </tr>
                                        @endif
                                    </table>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4; border:1px solid #bbf7d0; border-radius:10px; margin-bottom:28px;">
                            <tr>
                                <td style="padding:16px 20px;">
                                    ...
                                    <p style="margin:0; font-size:13px; color:#15803d; line-height:1.6;">{{ $justification }}</p>
                                </td>
                            </tr>
                        </table>
                        @else
                            ...
                            <tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff1f2; border:1px solid #fecdd3; border-radius:10px;">
                                        <tr>
                                            <td style="padding:16px; text-align:center;">
                                                <div style="font-size:26px; font-weight:800; color:#be123c;">{{ $totalAbsences }}</div>
                                ...
                                <td width="32%" style="padding:0 3px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff7ed; border:1px solid #fed7aa; border-radius:10px;">
                                        <tr>
                                            <td style="padding:16px; text-align:center;">
                                                <div style="font-size:26px; font-weight:800; color:#c2410c;">{{ $totalHeuresAbsence }}h</div>
                                ...
                                <td width="32%" style="padding-left:6px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" style="background:{{ $tauxPresence >= 75 ? '#f0fdf4' : '#fff1f2' }}; border:1px solid {{ $tauxPresence >= 75 ? '#bbf7d0' : '#fecdd3' }}; border-radius:10px;">
                                        <tr>
                                            <td style="padding:16px; text-align:center;">
                                                <div style="font-size:26px; font-weight:800; color:{{ $tauxPresence >= 75 ? '#16a34a' : '#be123c' }};">{{ $tauxPresence }}%</div>
                                                <div style="font-size:10px; color:{{ $tauxPresence >= 75 ? '#15803d' : '#9f1239' }}; margin-top:3px; font-weight:600;">Taux de présence</div>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
