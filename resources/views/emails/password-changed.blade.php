                ...
                <tr>
                    <td style="background:#f8fafc; border:1px solid #e2e8f0;
                        ...
                        <p style="margin:0; color:#94a3b8; font-size:11px;">
                            © {{ date('Y') }} Système de gestion OFPPT — Ne pas répondre à cet e-mail
                        </p>
                    </td>
                </tr>
