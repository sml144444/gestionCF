         ...
         <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
            ...
            <tr>
               <td style="background:white;padding:36px 48px;">
                  ...
                  {{-- ✅ NEW: Login credentials with password --}}
                  <div style="background:#eef2ff;border-radius:16px;border:1.5px solid #c7d2fe;
                     ...
                     <ul style="margin:0;padding-left:20px;list-style-type:disc;color:#1e293b;font-size:14px;">
                        <li style="margin-bottom:10px;">
                           <strong>Email :</strong> <span style="font-family:'Courier New',monospace;">{{ $user->email }}</span>
                        </li>
                        <li style="margin-bottom:10px;">
                           <strong>Mot de passe :</strong> <span style="font-family:'Courier New',monospace;background:#e2e8f0;padding:2px 8px;border-radius:6px;">{{ $plainPassword }}</span>
                        </li>
                     </ul>
                     <p style="margin:14px 0 0 0;font-size:12px;color:#475569;">
                        📎 Connectez-vous sur : <a href="{{ url('/login') }}" style="color:#1a5fa8;font-weight:600;">{{ url('/login') }}</a>
                     </p>
                  </div>
