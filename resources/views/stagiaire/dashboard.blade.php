    ...
    <div class="relative px-6 py-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-blue-200 text-sm mt-1">
                @if($filiere && $groupe)
                    {{ $filiere->name }} · {{ $groupe->name }} · {{ $groupe->annee }}ème Année
                @elseif($groupe)
                    {{ $groupe->name }} · {{ $groupe->annee }}ème Année
                @else
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
    ...
    <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
        ...
        <p class="text-base font-black text-slate-800 leading-tight truncate">{{ $filiere->name ?? '—' }}</p>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5">
        ...
        <p class="text-base font-black text-slate-800 leading-tight truncate">{{ $groupe->name ?? '—' }}</p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="flex flex-col gap-5">
        ...
        {{-- Accès rapide — même style que admin (grille icônes) --}}
            ...
            <div class="p-4 grid grid-cols-2 gap-3">
                ...
                <a href="{{ $route }}"
                   ...
                   style="background:{{ $bg }};">
                    ...
                    <span class="text-[11px] font-bold leading-tight" style="color:{{ $color }};">{{ $label }}</span>
                </a>
                @endforeach
            </div>
        </div>
