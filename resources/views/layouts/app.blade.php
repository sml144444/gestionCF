...
@endphp
    ...
    {{-- ════ SIDEBAR ════ --}}
    <aside id="sidebar"
           class="h-full flex flex-col flex-shrink-0 transition-all duration-300 ease-in-out {{ $sidebarColor }}"
        ...
        {{-- ── NAVIGATION ── --}}
        {{-- Une seule sidebar, les liens s'affichent selon les permissions Spatie --}}
